...
namespace NAIM
{
    class Program
    {
        ...
        {
            db = new DatabaseInterface("credentials.txt");
            Server s = new Server(port);
            Console.ReadLine();
        }

        public static void Log(ConsoleColor level, string message)
        {
        ...
        class Server
        {
            ...
            {
                Log(ConsoleColor.Cyan, "Server initialising...");
            ...
            private void Listen()
            {
                ...
                Log(ConsoleColor.Cyan, "Listening for incoming packets on port " + port + "...");
                while (true)
                {
            ...
            private void Communicate(object client)
            {
                ...
                Log(ConsoleColor.Green, "Inbound connection recieved from " + tcpClient.Client.RemoteEndPoint + ".");
                ...
                Log(ConsoleColor.Yellow, "Client " + tcpClient.Client.RemoteEndPoint + " has disconnected.");
                tcpClient.Close();
            }
